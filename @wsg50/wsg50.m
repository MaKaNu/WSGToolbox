        ...
        function decode_status(Obj)
            switch Obj.status_R
                ...
                case['0A'; '00']
                    ...
                    disp('Nicht gen�gend Speicher vorhanden.')
                case ['0B'; '00']
                    disp('E_CHECKSUM_ERROR')
                    disp('Pr�fsummenfehler.')
                case ['0C'; '00']
                    disp('E_NO_PARAM_EXPECTED')
                    disp('Parameter �bergeben, obwohl keiner erwartet.')
                case ['0D'; '00']
                    disp('E_NOT_ENOUGH_PARAMS')
                    disp('Zu wenige Parameter f�r den Befehl �bergeben.')
                case ['0E'; '00']
                    disp('E_CMD_UNKNOWN')
                ...
                case ['11'; '00']
                    disp('E_ALREADY_OPEN')
                    disp('Schnittstelle ist bereits ge�ffnet.')
                case ['12'; '00']
                    disp('E_CMD_FAILED')
                    disp('Fehler w�hrend der Ausf�hrung eines Befehls.')
                case ['13'; '00']
                    disp('E_CMD_ABORTED')
                    disp('Befehlsausf�hrung vom Benutzer abgebrochen.')
                case ['14'; '00']
                    disp('E_INVALID_HANDLE')
                    disp('Ung�ltiges Handle.')
                case ['15'; '00']
                    disp('E_NOT_FOUND')
                    disp('Ger�t oder Datei nicht gefunden.')
                case ['16'; '00']
                    disp('E_NOT_OPEN')
                    disp('Ger�t oder Datei nicht ge�ffnet.')
                case ['17'; '00']
                    disp('E_IO_ERROR')
                    disp('Ein-/Ausgabefehler.')
                case ['18'; '00']
                    disp('E_INVALID_PARAMETER')
                    disp('Ung�ltiger Parameter.')
                case ['19'; '00']
                    disp('E_INDEX_OUT_OF_BOUNDS')
                    disp('Index au�erhalb des zul�ssigen Bereichs.')
                case ['1A'; '00']
                    disp('E_CMD_PENDING')
                    disp(strcat('Der Befehl wurde noch nicht',...
                                ' vollst�ndig ausgef�hrt.'))
                    disp(strcat('Eine R�ckmeldung mit Statuscode folgt',...
                                ' nach Ausf�hrung des Befehls.'))
                case ['1B'; '00']
                    disp('E_OVERRUN')
                    disp('Daten�berlauf.')
                case ['1C'; '00']
